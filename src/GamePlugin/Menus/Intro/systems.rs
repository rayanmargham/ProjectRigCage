...
use crate::GamePlugin::{
    ...
    Menus::Letters::{LetterBundle, LetterBundle3D},
    PreLoader,
};
use bevy::prelude::*;
...
pub fn intro_init(
    ...
    audio: Res<Audio>,
    preloaded: Res<PreLoader::PreloadFunkinAssets>,
    mut atlases: ResMut<Assets<TextureAtlas>>
) {
    let handle = audio
        .play(preloaded.freaky.clone())
        .looped()
        .with_volume(0.7)
...
pub fn freakybeathit(
    mut next_state: ResMut<NextState<GameState>>,
    ninjapuffin: Res<wackymuffin>,
    brand: Res<Branding>,
    conduct: Res<Conductor::Conductor>,
    mut reader: EventReader<ConductorEvents>,
    mut commands: Commands,
    query: Query<Entity, With<FreakyText>>,
        ...
        match ev {
            ConductorEvents::BeatHit => {
                match conduct.curBeat {
                    1 => {
                        let ent = LetterBundle3D::new(
                            "Rust Rewrite By".to_string(),
                            &mut commands,
                            &preloaded,
                            &mut sprite_params,
                            Transform::from_xyz(-3.3, 0.8, -10.0),
                            false,
                        )
                        .unwrap();
                    ...
                    5 => {
                        let ent = LetterBundle3D::new(
                            ...
                            &preloaded,
                            &mut sprite_params,
                            Transform::from_xyz(-2.1, 2.0, -10.0),
                            false,
                        )
                        .unwrap();
                    ...
                    9 => {
                        let ent = LetterBundle3D::new(
                            ninjapuffin.text1.clone(),
                            &mut commands,
                            &preloaded,
                            &mut sprite_params,
                            Transform::from_xyz(0.0, 0.8, -10.0),
                            true,
                        )
                        .unwrap();
                    ...
                    13 => {
                        let ent = LetterBundle3D::new(
                            ...
                            &preloaded,
                            &mut sprite_params,
                            Transform::from_xyz(-1.39, 1.2, -10.0)
                    ...
                    14 => {
                        let ent = LetterBundle3D::new(
                            ...
                            &preloaded,
                            &mut sprite_params,
                            Transform::from_xyz(0.0, 0.3, -10.0),
                            true,
                        )
                        .unwrap();
                    ...
                    15 => {
                        let ent = LetterBundle3D::new(
                            ...
                            &preloaded,
                            &mut sprite_params,
                            Transform::from_xyz(-1.25, -0.6, -10.0),
                            false,
                        )
                        .unwrap();
